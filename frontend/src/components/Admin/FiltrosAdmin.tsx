...
const Filtros: React.FC<FiltrosProps> = ({ onResponsableChange, onBuscarChange }) => {
  ...
  // 🔹 Obtiene lista única de responsables desde los datos
  const responsables = Array.from(
    new Set(data.map((t) => t.responsable).filter(Boolean))
  ).sort();
    ...
    <div className="w-full bg-white font-sans p-3 md:p-4 border-b border-gray-200">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        >
          ...
          {/* 🔸 Botón limpiar — solo se muestra si hay un responsable distinto de “Todos” */}
