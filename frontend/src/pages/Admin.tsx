// 📍 src/pages/Admin.tsx (o donde lo tengas ubicado)
...
// import ModalAceptar from "../components/Admin/ModalAceptar";
...
const Admin: React.FC<AdminProps> = ({ user }) => {
  ...
  // Esta función ahora es válida gracias a la importación corregida
  const fetchTareas = useCallback(async () => {
    setLoading(true);
    try {
      // Usamos 'getAll' como definiste en tu tareasService
